            ...
            <TableBody>
              {genreRows.map((row) => (
                <TableRow key={row.genre_id}>
                  <TableCell className="font-medium">{row.genre_name}</TableCell>
                  <TableCell className="text-right">{Number(row.order_count).toLocaleString()}</TableCell>
                  <TableCell className="text-right">{Number(row.total_units_sold).toLocaleString()}</TableCell>
